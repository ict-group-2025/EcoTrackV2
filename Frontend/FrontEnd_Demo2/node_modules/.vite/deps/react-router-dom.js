...
//#region node_modules/react-router/dist/development/chunk-WWGJGFF6.mjs
...
function RouterProvider({ router: router$1, flushSync: reactDomFlushSyncImpl, unstable_onError, unstable_useTransitions }) {
	...
	let setState = import_react.useCallback((newState, { deletedFetchers, newErrors, flushSync, viewTransitionOpts }) => {
		if (newErrors && unstable_onError) Object.values(newErrors).forEach((error) => unstable_onError(error, {
...
try {
	if (isBrowser) window.__reactRouterVersion = "7.10.1";
} catch (e) {}
...
function useLinkClickHandler(to, { target, replace: replaceProp, state, preventScrollReset, relative, viewTransition, unstable_useTransitions } = {}) {
	let navigate = useNavigate();
	let location$1 = useLocation();
...
//#endregion
//#region node_modules/react-router/dist/development/chunk-PMGK554W.mjs
/**
* react-router v7.10.1
*
* Copyright (c) Remix Software Inc.
